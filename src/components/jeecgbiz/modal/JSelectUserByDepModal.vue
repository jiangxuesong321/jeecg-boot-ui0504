      ...
      <a-col :md="18" :sm="24">
        <a-card :bordered="false">
          <a-form-model>
            ...
            <a-col :span="6">
              <a-button style="margin-top: 3px;z-index: 99" @click="onSearch" type="primary">查询</a-button>
              <a-button @click="searchReset(1)"  style="margin-top: 3px;z-index: 99;margin-left: 5px" type="primary">重置</a-button>
            </a-col>
          </a-form-model>
          <!--用户列表-->
          <a-table
