    ...
    <div class="card-title">
      项目合同进度报表
		...
		<div class="table-page-search-wrapper">
          ...
          <a-col :span="6">
            <a-form-item label="流程节点" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
              <a-input v-model="queryParam.processNode"></a-input>
            </a-form-item>
          </a-col>
          ...
          <a-col :span="8">
            ...
            <a-button type="primary" icon="download" @click="handleExportXls('项目合同进度报表')" style='margin-left: 8px'>导出</a-button>
          </a-col>
				</a-row>
			</a-form>
		</div>
	...
	export default {
      ...
      this.components = {
        ...
        columns,
				...
				url: {
					list: "/srm/report/fetchContractProgressPageList",
          exportXlsUrl: "/srm/report/exportContractProgressPageList",
				},
				dictOptions: {},
				superFieldList: [],
			}
