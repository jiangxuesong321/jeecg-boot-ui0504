  ...
  <a-card :bordered="false">
    ...
    <div>
      ...
      <a-table ref="table" size="middle" :scroll="{ x: true, y: 500 }" bordered rowKey="id" :columns="columns"
        :dataSource="dataSource" :pagination="ipagination" :loading="loading" @change="handleTableChange" @expand="open"
        :customRow="customRow" :expandedRowKeys="expandedRowKeys">
      ...
      <div
        :style="dataSource != null && dataSource.length > 0 ? 'z-index:99;margin-top:-43px;' : 'z-index:99;margin-top:10px;'">
    ...
    <a-drawer title="产能维护" :width="width" placement="right" :closable="false" :headerStyle="{ textAlign: 'center' }"
      ...
      <a-table ref="table" size="middle" bordered :scroll="{ x: true, y: 300 }" :columns="childColumns" :dataSource="modelList"
        :pagination="false">
    ...
    <a-drawer title="子项产线人员配置" :width="width" placement="right" :closable="false" :headerStyle="{ textAlign: 'center' }"
      ...
      <a-table ref="table" size="middle" bordered :scroll="{ x: true, y: 300 }" :columns="subkeyColumns"
        :dataSource="subkeyList" :pagination="false">
