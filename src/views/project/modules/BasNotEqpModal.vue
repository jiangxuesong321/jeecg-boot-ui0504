...
<!--      <a-row :gutter="24">-->
<!--        <a-col :span="5">预算总金额(元)：</a-col><a-col :span="2"><span style="color:coral;font-weight: bold;font-size:18px;">{{budgetAmount}}</span></a-col>-->
<!--        <a-col :span="5">剩余总金额(元)：</a-col><a-col :span="2"><span style="color:coral;font-weight: bold;font-size:18px;">{{remainAmount}}</span></a-col>-->
<!--      </a-row>-->
    </div>
    <a-table ref="tableSet" size="middle" class="j-table-force-nowrap" :scroll="{x:1200,y:500}"
        ...
        columns: [
          ...
          },
          {
            ...
            customRender:function (t,r,index) {
              let icon = "";
              icon = '¥';
              return icon + iegAmount(Math.trunc(t),'total')
            }
          },
          // {
          //   title: '冻结金额',
