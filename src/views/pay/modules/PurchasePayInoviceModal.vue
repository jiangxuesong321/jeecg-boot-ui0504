...
<!--  <j-modal
  ...
  <a-drawer
    ...
    destroyOnClose
    :visible="visible">
    <purchase-pay-inovice-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"></purchase-pay-inovice-form>
...
<script>
  ...
  import PurchasePayInoviceForm from './PurchasePayInoviceForm'
  export default {
    name: 'PurchasePayInoviceModal',
    components: {
      PurchasePayInoviceForm
    },
    data () {
      return {
        title:'',
