...
<!--              <a-input placeholder="请输入项目名称" v-model="queryParam.projectName"></a-input>-->
    ...
    <purchase-pay-inovice-modal ref="modalForm" @ok="modalFormOk"></purchase-pay-inovice-modal>
...
import ContractBaseModal from '@views/contract/modules/ContractBaseModal'
  ...
  import PurchasePayInoviceModal from './modules/PurchasePayInoviceModal'
