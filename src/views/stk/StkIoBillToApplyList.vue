    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical" v-if="record.status =='0'  && roleCode.indexOf(record.approverId) > -1 && record.approverId == 'project_center'"/>
          <a @click="handleApprove(record)" v-if="record.status =='0'  && roleCode.indexOf(record.approverId)  > -1 && record.approverId == 'project_center'">确认</a>

          <a-divider type="vertical" v-if="record.status =='0' && record.approverId == 'prod_line' && roleCode.indexOf(record.approverId) > -1" />
          <a @click="handleApprove(record)" v-if="record.status =='0' && record.approverId == 'prod_line' && roleCode.indexOf(record.approverId) > -1">确认</a>
    ...
    // },
    {
      ...
      customRender:function (text,record) {
        if(record.status == '1'){
          ...
          return text + "(" + record.approverId_dictText + ")";
        }
