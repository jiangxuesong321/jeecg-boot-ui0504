          ...
          <a-row>
            ...
            <a-col :span="8">
              <a-form-model-item label="报价(含税)" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
                {{iegAmount(model.orderPriceTax,'total')}}
              </a-form-model-item>
            </a-col>
            <a-col :span="8">
          ...
          <a-row>
            <a-col :span="8">
              <a-form-model-item label="议价价格" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
                <a-input-number v-model="model.bgOrderPriceTax" style="width: 100%" @change="setValue"></a-input-number>
              </a-form-model-item>
            </a-col>
<!--            <a-col :span="8">-->
<!--              <a-form-model-item label="运费" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">-->
...
export default {
  ...
  methods: {
    ...
    handleOk(){
      let that = this;
      let bgOrderPriceTax = that.model.bgOrderPriceTax;
      if(isNullOrEmpty(bgOrderPriceTax)){
