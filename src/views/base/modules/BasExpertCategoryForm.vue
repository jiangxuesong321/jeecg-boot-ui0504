        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="是否启用" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="isEnabled">
              <a-input-number v-model="model.isEnabled" placeholder="请输入是否启用" style="width: 100%" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/srm/basExpertCategory/add",
          edit: "/srm/basExpertCategory/edit",
          queryById: "/srm/basExpertCategory/queryById"
        }
      }
    },
    computed: {
