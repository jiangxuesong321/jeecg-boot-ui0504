<template>
  <a-drawer
    ...
    <a-card :bordered="false">
      <j-form-container class="top-div">
        <a-form-model ref='form' :model='model'  slot='detail'>
          <a-row class="display-flex">
            <a-col class="img-detail">
              <a-form-model-item label='' :labelCol='labelCol3' :wrapperCol='wrapperCol3' >
                <j-image-upload class='avatar-uploader' text='logo' v-model='model.logoUrl'
                                style='margin-left: 0px;' :disabled='disabled'></j-image-upload>
              </a-form-model-item>
            </a-col>
            <a-col :span="18" style="padding-top: 10px;">
				<a-row>
					...
					<a-col >
						<a-form-model-item class="item-flex green" >
						  {{model.supplierPropDict}}
						</a-form-model-item>
						<a-form-model-item class="item-flex blue" >
						  {{model.supplierTypeDict}}
						</a-form-model-item>
            <a-form-model-item class="item-flex blue" >
              {{model.supplierGrade}}
            </a-form-model-item>
						<a-form-model-item class="item-flex qingse" v-if="model.endTime != null && model.endTime != undefined">
						  {{model.endTime}}到期
						</a-form-model-item>
					</a-col>
				</a-row>
      ...
      <a-row>
        <a-tabs v-model:activeKey="activeKey" @change="handleChange">
          <a-tab-pane key="0" tab="基本信息">
            <a-col :span="8" >
              <a-form-model-item label="供应商简称" :labelCol="labelCol3" :wrapperCol="wrapperCol3"  >
                {{model.shortName}}
              </a-form-model-item>
            </a-col>

            <a-col :span="8" >
              <a-form-model-item label="网站地址" :labelCol="labelCol3" :wrapperCol="wrapperCol3"  >
                {{model.website}}
              </a-form-model-item>
            </a-col>

            <a-col :span="8" >
              <a-form-model-item label="注册资本" :labelCol="labelCol3" :wrapperCol="labelCol3"  >
                {{model.registerCapital}}
              </a-form-model-item>
            </a-col>

            <a-col :span="8" >
              <a-form-model-item label="供应商邮箱" :labelCol="labelCol3" :wrapperCol="wrapperCol3"  >
                {{model.email}}
              </a-form-model-item>
            </a-col>

            <a-col :span="8" >
              <a-form-model-item label="供应商传真" :labelCol="labelCol3" :wrapperCol="wrapperCol3"  >
                {{model.fax}}
              </a-form-model-item>
            </a-col>

            <a-col :span="8" >
              <a-form-model-item label="联系人" :labelCol="labelCol3" :wrapperCol="wrapperCol3"  >
                {{model.contacter}}
              </a-form-model-item>
            </a-col>

            <a-col :span="8" >
              <a-form-model-item label="联系电话" :labelCol="labelCol3" :wrapperCol="wrapperCol3"  >
                {{model.contacterTel}}
              </a-form-model-item>
            </a-col>
            ...
            <a-col :span="24" >
              <a-form-model-item label="经营地址" :labelCol="labelCol" :wrapperCol="wrapperCol3"  >
                {{model.bizArea}}
              </a-form-model-item>
            </a-col>

            <a-col :span="24" >
              <a-form-model-item label="开票地址" :labelCol="labelCol" :wrapperCol="wrapperCol3"  >
                {{model.invoiceAddress}}
              </a-form-model-item>
            </a-col>

            <a-col :span="24" >
              <a-form-model-item label="注册地址" :labelCol="labelCol" :wrapperCol="wrapperCol3" >
                {{model.registerArea}}
              </a-form-model-item>
            </a-col>

            <a-col :span="24" >
              <a-form-model-item label="营业执照" :labelCol="labelCol" :wrapperCol="wrapperCol3"  >
                <j-image-upload class='avatar-uploader' text='logo' v-model='model.supplierAttachment'
                                style='margin-left: 10px;' :disabled='disabled'></j-image-upload>
              </a-form-model-item>
            </a-col>
            <a-col :span="24" >
				<span class="draw-title">更过资料</span>
            </a-col>
            <a-col :span="24" >
              <a-tabs v-model="childKey">
                <a-tab-pane tab="联系人信息" key="0">
                  ...
                  >
                    ...
                    <template slot-scope="text,record,index" slot="contacter">
                      <a-input v-model="record.contacter" placeholder="联系人" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="contacterEmail">
                      <a-input v-model="record.contacterEmail" placeholder="联系人邮箱" disabled :maxLength="30"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="contacterTel">
                      <a-input v-model="record.contacterTel" placeholder="联系人电话" disabled :maxLength="11"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="contacterPosition">
                      <a-input v-model="record.contacterPosition" placeholder="联系人职位" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="contacterDepartment">
                      <a-input v-model="record.contacterDepartment" placeholder="联系人部门" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="contacterAddress">
                      <a-input v-model="record.contacterAddress" placeholder="联系人地址" disabled :maxLength="100"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="isDefault">
                      <j-dict-select-tag type="select" v-model="record.isDefault" dictCode="yn" placeholder="是否默认" style="width: 100%" disabled/>
                    </template>

                    <template slot-scope="text,record,index" slot="remark">
                      <a-input v-model="record.remark" placeholder="备注" type="textarea" disabled :maxLength="200"></a-input>
                    </template>
                ...
                <a-tab-pane tab="资质证书" key="1">
                  ...
                  >
                    ...
                    <template slot-scope="text,record,index" slot="qualificationName">
                      <a-input v-model="record.qualificationName" placeholder="资质证书名称" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="qualUrl">
                      <j-upload v-model="record.qualUrl" :trigger-change="true" disabled></j-upload>
                    </template>

                    <template slot-scope="text,record,index" slot="valideDateBegin">
                      <a-date-picker v-model="record.valideDateBegin" placeholder="有效开始日期" style="width: 100%" disabled/>
                    </template>

                    <template slot-scope="text,record,index" slot="valideDateEnd">
                      <a-date-picker v-model="record.valideDateEnd" placeholder="有效结束日期" style="width: 100%" disabled/>
                    </template>
                ...
                <a-tab-pane tab="银行账号" key="2">
                  ...
                  >
                    <template slot-scope="text,record,index" slot="bankAccountName">
                      <a-input v-model="record.bankAccountName" placeholder="账户名称" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="bankAccountNum">
                      <a-input v-model="record.bankAccountNum" placeholder="银行账号" disabled :maxLength="30"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="bankBranch">
                      <a-input v-model="record.bankBranch" placeholder="开户行" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="bankName">
                      <a-input v-model="record.bankName" placeholder="所属银行" disabled :maxLength="20"></a-input>
                    </template>
                    ...
                    <template slot-scope="text,record,index" slot="swiftCode">
                      <a-input v-model="record.swiftCode" placeholder="swiftCode" disabled :maxLength="20"></a-input>
                    </template>
                    ...
                    <template slot-scope="text,record,index" slot="type">
                      ...
                      <j-dict-select-tag style="width:100%;" v-model="record.type" placeholder="账户性质"
                                         dictCode="account_type" disabled/>
                    </template>
                ...
                <a-tab-pane tab="寄件信息" key="3">
                  ...
                  >
                    <template slot-scope="text,record,index" slot="sender">
                      <a-input v-model="record.sender" placeholder="寄件人" disabled :maxLength="20"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="senderTel">
                      <a-input v-model="record.senderTel" placeholder="寄件人联系方式" disabled :maxLength="30"></a-input>
                    </template>

                    <template slot-scope="text,record,index" slot="areaList">
                      <a-cascader v-model="record.areaList" :options="options" placeholder="寄件地区" style='width: 100%' disabled/>
                    </template>

                    <template slot-scope="text,record,index" slot="address">
                      <a-input v-model="record.address" placeholder="寄件地址" disabled type='cascader'></a-input>
                    </template>
          ...
          <a-tab-pane key="1" tab="业务数据">
            <a-tabs v-model="tabKey" @change="handleChild">
              <a-tab-pane tab="合同信息" key="0">
                <a-table
                  ref="table"
                  size="middle"
                  bordered
                  rowKey="id"
                  :scroll="{x:true,y:300}"
                  :columns="basContractTemplateTable.columns"
                  :dataSource="basContractTemplateTable.dataSource"
                  :pagination="basContractTemplateTable.ipagination"
                  @change="handleTableChange"
                  @expand="open"
                  :expandedRowKeys="expandedRowKeys">
                  <template slot="contractNumber" slot-scope="text,record">
                    <a @click="handleContract(record,'0')">{{text}}</a>
                  </template>
...
<!--                            <th width="10%">发票类型</th>-->
<!--                            <th width="10%">发票税率</th>-->
<!--                            <th width="10%">开票金额(含税)</th>-->
<!--                            <th width="10%">开票金额(未税)</th>-->
<!--                            <th width="10%">开票日期</th>-->
<!--                          </tr>-->
<!--                        </thead>-->
<!--                        <tbody>-->
...
<!--                            <td>{{index + 1}}</td>-->
<!--                            <td>{{item.invoiceType_dictText}}</td>-->
<!--                            <td>{{item.invoiceTax}}</td>-->
<!--                            <td>{{item.invoiceAmountTax}}</td>-->
...
<!--                  </div>-->
              ...
              <a-tab-pane tab="付款申请单详情" key="1">
                <a-table
                  ...
                  rowKey="id"
                  :scroll="{x:true,y:300}"
                  :columns="basPayTable.columns"
                  :dataSource="basPayTable.dataSource"
                  :pagination="basPayTable.ipagination"
                  @change="handleTableChange1"
                >
                  <template slot="contractNumber" slot-scope="text,record">
                    <a @click="handleContract(record,'1')">{{text}}</a>
                  </template>
                </a-table>
              </a-tab-pane>
            </a-tabs>
  ...
  export default {
    ...
    methods:{
      ...
      open(expanded, row) {
        this.childList = []
        if (expanded) {
          let url = '/srm/purchasePayInovice/queryPurPayInvoiceByContractId'
          let param = {
            id: row.id
          }
      ...
      handleTableChange1(pagination, filters, sorter){
        this.basPayTable.ipagination = pagination;
        this.fetchPayApply(null,this.model.id);
      },
      fetchPayApply(arg,suppId){
        this.basPayTable.dataSource = [];
        //加载数据 若传入参数1则加载第一页的内容
        if (arg === 1) {
          this.basPayTable.ipagination.current = 1;
        }
        let params = {
          suppId : suppId
        }
        let url = "/srm/purPayApply/list";
        getAction(url, params).then((res) => {
          if (res.success) {
            this.basPayTable.dataSource = res.result.records||res.result;
            if(res.result.total)
            {
              this.basPayTable.ipagination.total = res.result.total;
            }else{
              this.basPayTable.ipagination.total = 0;
            }
      ...
      handleTableChange(pagination, filters, sorter) {
        this.basContractTemplateTable.ipagination = pagination;
        this.fetchContractBySupp(null,this.model.id);
      },
      fetchContractBySupp(arg,suppId) {
        this.basContractTemplateTable.dataSource = [];
        //加载数据 若传入参数1则加载第一页的内容
        if (arg === 1) {
          this.basContractTemplateTable.ipagination.current = 1;
        }
        let params = {
          contractSecondPartyId : suppId
        }
        let url = "/srm/contractBase/fetchContractBySupp";
        getAction(url, params).then((res) => {
          if (res.success) {
            this.basContractTemplateTable.dataSource = res.result.records||res.result;
            if(res.result.total)
            {
              this.basContractTemplateTable.ipagination.total = res.result.total;
            }else{
              this.basContractTemplateTable.ipagination.total = 0;
            }
            //update-end---author:zhangyafei    Date:20201118  for：适配不分页的数据列表------------
          }else{
            this.$message.warning(res.message)
...
<style>
	...
	.drawer-body .ant-drawer-wrapper-body .ant-drawer-body{
		background: #F1F1F1;
		padding: 15px 10px;
	}
	.top-div .ant-upload-select-picture-card{
		border-radius: 50%;
	}
	.img-detail {
		width: 120px; height: 100px;padding-left: 20px; margin-right: 30px;
	}
	.img-detail  .ant-upload.ant-upload-select-picture-card {
	...
	.item-flex .ant-form-item-control{
		line-height: 20px;
	}
	.ant-tabs-nav-scroll{
