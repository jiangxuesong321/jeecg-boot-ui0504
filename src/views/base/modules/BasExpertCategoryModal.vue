...
<!--
  <j-modal
    ...
    @cancel="handleCancel"
    cancelText="关闭">
    <bas-expert-category-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit"></bas-expert-category-form>
  </j-modal>
-->
...
<script>
  ...
  import BasExpertCategoryForm from './BasExpertCategoryForm'
  export default {
    name: 'BasExpertCategoryModal',
    components: {
      BasExpertCategoryForm
    },
    data () {
      return {
        title:'',
