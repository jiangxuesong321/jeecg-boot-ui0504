...
<!--					  </a-col>-->
    ...
    <div class="table-operator">
      ...
      <a-table
        ...
        <template slot="quoteFile" slot-scope="text,record">

        </template>

        <template slot="openBiddingDate" slot-scope="text,record">
      ...
      <div :style="dataSource != null && dataSource.length > 0 ? 'z-index:99;margin-top:-43px;' : 'z-index:99;margin-top:10px;'">
		...
		<purchase-request-goods-main-modal ref="modalForm" @ok="modalFormOk" ptype="normal"/>
	</a-card>
</template>
...
let columns = [
    ...
    // },
    {
      ...
      align: "center",
      sorter: true,
      dataIndex: 'reqCategory_dictText',
      width: 120,
    },
  	{
  		title: '申请部门',
...
export default {
      ...
      ListColumnsSetter
        ...
        //     width: 200,
				...
				// ],
				url: {
					list: "/srm/purchaseRequestMain/goodList",
