...
<!--            </a-col>-->
            ...
            <a-col :span="8">
              <a-form-model-item label="申请人部门" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3" prop="reqOrgName">
				...
				<!-- 子表单区域 -->
        <a-card class="card" title="寻源清单" :bordered="false" >
          <a-button type="primary" :disabled="formDisabled" style="float: right;overflow: hidden;margin-bottom: 10px;z-index: 99999" @click="openDialog">添加物料</a-button>
          <a-table
            ref="table"
            size="middle"
            bordered
        ...
        <a-card class="card" title="其他配置附件" :bordered="false">
          <a-row>
            <a-col :span="24">
              <a-button type="primary" style="float: right;z-index: 999;margin-top: -55px;" size="small"
                        @click="changeFileName(model.id,model.attachment,'attachment','attachment')" v-if="model.attachment != null">修改文件名</a-button>
              <a-form-item label="其他配置附件" :labelCol="spans.labelCol1" :wrapperCol="spans.wrapperCol1">
                <j-upload v-model="model.attachment" :trigger-change="true" :disabled="formDisabled"></j-upload>
              </a-form-item>
            </a-col>
          </a-row>
        </a-card>
        <a-card class="card" title="物料配套说明" :bordered="false">
          <a-row>
            <a-col :span="24">
              <a-form-item label="物料配套说明" :labelCol="spans.labelCol1" :wrapperCol="spans.wrapperCol1">
                <a-input v-model="model.comment" placeholder="物料配套说明" :rows="3" type='textarea' :disabled="formDisabled">
                </a-input>
              </a-form-item>
            </a-col>
          </a-row>
...
<!--          </a-row>-->
    ...
    <a-drawer
      ...
      destroyOnClose
      :visible="visible">
      <bas-eqp-list ref="eqpList" @back="back" ptype="proj" :projId="model.projectId" :reqId="model.id" :categoryId="model.categoryId"></bas-eqp-list>
...
export default {
		name: 'PurchaseRequestGoodsMainForm',
      ...
      ChangeFileName
        ...
        columns:[
          ...
          //   width:120,
          //   align:"center",
          //   scopedSlots: { customRender: 'singleCapacity' },
          // },
          {
            title: '采购数量',
            dataIndex: 'qty',
