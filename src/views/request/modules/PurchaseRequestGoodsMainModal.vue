<template>
  ...
  <a-drawer
    ...
    destroyOnClose
    :visible="visible">
    <purchase-request-goods-main-form ref="realForm" @ok="submitCallback" :disabled="disableSubmit" :ptype="ptype"/>
    <!--采购申请页面进入-->
    ...
    <!--审批页面进入-->
    <div  style="text-align: center;" v-else-if="ptype == 'approve'">
    ...
    <div  style="text-align: center;" v-else-if="ptype == 'pur'">
...
import PurchaseRequestGoodsMainForm from './PurchaseRequestGoodsMainForm'

export default {
  name: 'PurchaseRequestGoodsMainModal',
  props:['ptype'],
  components: {
    PurchaseRequestGoodsMainForm
  },
  data() {
    return {
      title:'',
