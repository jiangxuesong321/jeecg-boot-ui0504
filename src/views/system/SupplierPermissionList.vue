...
<script>
  ...
  import { getSuppPermissionList } from '@/api/api'
  ...
  export default {
    ...
    data() {
      return {
        ...
        expandedRowKeys: [],
        url: {
          list: '/srm/supplierPermission/list',
          delete: '/srm/supplierPermission/delete',
          deleteBatch: '/srm/supplierPermission/deleteBatch'
        }
      }
    },
    methods: {
      loadData() {
        this.dataSource = []
        getSuppPermissionList().then((res) => {
          if (res.success) {
