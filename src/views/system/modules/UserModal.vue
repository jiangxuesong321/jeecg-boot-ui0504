  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="角色分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!roleDisabled" v-if="action != 'homePage'">
          <j-multi-select-tag
        ...
        <a-form-model-item label="部门分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled">
          <j-select-depart v-model="model.departIds" :multi="false" :backDepart="true" :treeOpera="true">></j-select-depart>
        </a-form-model-item>
...
<!--        </a-form-model-item>-->
        ...
        <a-form-model-item label="是否允许外网访问" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="isOutNet" v-if="action != 'homePage'">
          <j-dict-select-tag  v-model="model.isOutNet" placeholder="是否允许外网访问" dictCode="yn"/>
        </a-form-model-item>

        <a-form-model-item label="所属主体" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="action != 'homePage'">
          <j-multi-select-tag
